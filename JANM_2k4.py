...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://pastebin.com/raw/awrSwDZZ/test/blob/main/a.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/JANM.7732")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/JANM.7732")
	subprocess.check_output(["am", "start", "https://pastebin.com/raw/awrSwDZZ"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://pastebin.com/raw/awrSwDZZ/test/blob/main/a.txt').text
			if basesplit in plr:
				key = basesplit
